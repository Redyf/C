...
// #define PROFESSOR 31 // Pensar sobre essa variável
...
// Função para inserir um registro no arquivo TODO: implementar essa função para alunos e funcionários. inserirRegistroAluno e inserirRegistroFuncionario.
...
// Função para apagar um registro do arquivo. TODO: criar uma função para os alunos e outra para funcionários, dessa forma podemos apagar os arquivos de cada um sem dificuldade.
