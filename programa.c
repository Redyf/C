...
// short = 2 bytes = 16 bits = 2^16  (Inteiro)
// int = 4 bytes = 32 bits = 2^32    (Inteiro)
// long = 8 bytes = 64 bits = 2^64   (Inteiro)
// double = 8 bytes = 64 bits = 2^64 (Casa decimal)
// float = 4 bytes = 32 bits = 2^32  (Casa decimal)
// O compilador lê da direita pra esquerda!
